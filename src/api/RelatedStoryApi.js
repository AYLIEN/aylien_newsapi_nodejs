...
/**
* RelatedStory service.
* @module api/RelatedStoryApi
* @version 4.0.0
*/
export default class RelatedStoryApi {

    /**
    * Constructs a new RelatedStoryApi. 
    * @alias module:api/RelatedStoryApi
    * @class
    ...
    */
     ...
     * @callback module:api/RelatedStoryApi~listRelatedStoriesGetCallback
     ...
     * @param {module:api/RelatedStoryApi~listRelatedStoriesGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/RelatedStoryApi~listRelatedStoriesPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RelatedStories} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} opts.storyLanguage This parameter is used for setting the language of the story. It supports [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language codes.  (default to 'auto')
     * @param {Number} opts.perPage This parameter is used for specifying number of items in each page.  (default to 3)
     * @param {module:api/RelatedStoryApi~listRelatedStoriesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RelatedStories}
     */
