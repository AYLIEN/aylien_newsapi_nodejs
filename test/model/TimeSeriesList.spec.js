...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AylienNewsApi.TimeSeriesList();
  });
  ...
  describe('TimeSeriesList', function() {
    it('should create an instance of TimeSeriesList', function() {
      // uncomment below and update the code to test TimeSeriesList
      //var instane = new AylienNewsApi.TimeSeriesList();
      //expect(instance).to.be.a(AylienNewsApi.TimeSeriesList);
    });
