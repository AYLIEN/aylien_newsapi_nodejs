...
/**
* Coverages service.
* @module api/CoveragesApi
* @version 3.0.0
*/
export default class CoveragesApi {

    /**
    * Constructs a new CoveragesApi. 
    * @alias module:api/CoveragesApi
    * @class
    ...
    */
     ...
     * @callback module:api/CoveragesApi~listCoveragesCallback
     ...
     * @param {module:api/CoveragesApi~listCoveragesCallback} callback The callback function, accepting three arguments: error, data, response
