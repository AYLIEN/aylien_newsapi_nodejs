    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('external_ids')) {
                obj['external_ids'] = ExternalIds.constructFromObject(data['external_ids']);

                if ('external_ids' !== 'externalIds') {
                  Object.defineProperty(obj, 'externalIds', {
                    get() {
...
/**
 * @member {module:model/ExternalIds} external_ids
 */
Entity.prototype['external_ids'] = undefined;
