...
export default class TrendsApi {
    ...
    */
     ...
     * @callback module:api/TrendsApi~listTrendsCallback
     ...
     * @param {module:api/TrendsApi~listTrendsCallback} callback The callback function, accepting three arguments: error, data, response
