...
> Coverages listCoveragesGet(opts)
...
let apiInstance = new AylienNewsApi.CoverageApi();
let opts = {
...
apiInstance.listCoveragesGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Coverages listCoveragesPost(opts)
...
apiInstance.listCoveragesPost(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
