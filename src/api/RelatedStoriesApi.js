...
/**
* RelatedStories service.
* @module api/RelatedStoriesApi
* @version 3.0.0
*/
export default class RelatedStoriesApi {

    /**
    * Constructs a new RelatedStoriesApi. 
    * @alias module:api/RelatedStoriesApi
    * @class
    ...
    */
     ...
     * @callback module:api/RelatedStoriesApi~listRelatedStoriesCallback
     ...
     * @param {module:api/RelatedStoriesApi~listRelatedStoriesCallback} callback The callback function, accepting three arguments: error, data, response
