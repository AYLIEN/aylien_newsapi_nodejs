...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AylienNewsApi.RepresentativeStory();
  });
  ...
  describe('RepresentativeStory', function() {
    it('should create an instance of RepresentativeStory', function() {
      // uncomment below and update the code to test RepresentativeStory
      //var instane = new AylienNewsApi.RepresentativeStory();
      //expect(instance).to.be.a(AylienNewsApi.RepresentativeStory);
    });
