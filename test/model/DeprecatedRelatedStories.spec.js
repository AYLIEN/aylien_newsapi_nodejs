...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AylienNewsApi.DeprecatedRelatedStories();
  });
  ...
  describe('DeprecatedRelatedStories', function() {
    it('should create an instance of DeprecatedRelatedStories', function() {
      // uncomment below and update the code to test DeprecatedRelatedStories
      //var instane = new AylienNewsApi.DeprecatedRelatedStories();
      //expect(instance).to.be.a(AylienNewsApi.DeprecatedRelatedStories);
    });
