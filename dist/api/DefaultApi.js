...
function () {
  ...
  */
  ...
  _createClass(DefaultApi, [{
    ...
    key: "listCoverages",
    value: function listCoverages(opts, callback) {
      opts = opts || {};
      var postBody = null;
      var pathParams = {};
      var queryParams = {
      ...
      var contentTypes = [];
      var accepts = ['application/json', 'text/xml'];
      var returnType = _Coverages["default"];
      return this.apiClient.callApi('/coverages', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
    ...
    key: "listRelatedStories",
    value: function listRelatedStories(opts, callback) {
      opts = opts || {};
      var postBody = null;
      var pathParams = {};
      var queryParams = {
