...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './Author', './Category', './Entities', './Media', './Sentiments', './ShareCounts', './Source', './StoryLinks', './Summary'], factory);
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('characters_count')) {
        obj['characters_count'] = ApiClient.convertToType(data['characters_count'], 'Integer');
      }
      if (data.hasOwnProperty('words_count')) {
        obj['words_count'] = ApiClient.convertToType(data['words_count'], 'Integer');
      }
      if (data.hasOwnProperty('sentences_count')) {
        obj['sentences_count'] = ApiClient.convertToType(data['sentences_count'], 'Integer');
      }
      if (data.hasOwnProperty('paragraphs_count')) {
        obj['paragraphs_count'] = ApiClient.convertToType(data['paragraphs_count'], 'Integer');
      }
   ...
   * @member {Integer} characters_count
   */
  exports.prototype['characters_count'] = undefined;

  /**
   * Words count of the story body
   * @member {Integer} words_count
   */
  exports.prototype['words_count'] = undefined;

  /**
   * Sentences count of the story body
   * @member {Integer} sentences_count
   */
  exports.prototype['sentences_count'] = undefined;

  /**
   * Paragraphs count of the story body
   * @member {Integer} paragraphs_count
   */
  exports.prototype['paragraphs_count'] = undefined;
   ...
   */
  exports.prototype['social_shares_count'] = undefined;
