 ...
 * @version 5.0.0
 */
var DeprecatedRelatedStories = /*#__PURE__*/function () {
  /**
   ...
   */
  function DeprecatedRelatedStories() {
    _classCallCheck(this, DeprecatedRelatedStories);
  ...
  _createClass(DeprecatedRelatedStories, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('related_stories')) {
          obj['related_stories'] = _ApiClient["default"].convertToType(data['related_stories'], [_DeprecatedStory["default"]]);
...
var _default = DeprecatedRelatedStories;
