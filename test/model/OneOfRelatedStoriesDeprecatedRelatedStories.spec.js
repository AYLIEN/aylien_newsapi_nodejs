...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AylienNewsApi.OneOfRelatedStoriesDeprecatedRelatedStories();
  });
  ...
  describe('OneOfRelatedStoriesDeprecatedRelatedStories', function() {
    it('should create an instance of OneOfRelatedStoriesDeprecatedRelatedStories', function() {
      // uncomment below and update the code to test OneOfRelatedStoriesDeprecatedRelatedStories
      //var instane = new AylienNewsApi.OneOfRelatedStoriesDeprecatedRelatedStories();
      //expect(instance).to.be.a(AylienNewsApi.OneOfRelatedStoriesDeprecatedRelatedStories);
    });
    ...
    it('should have the property publishedAtEnd (base name: "published_at.end")', function() {
      ...
      //var instance = new AylienNewsApi.OneOfRelatedStoriesDeprecatedRelatedStories();
