...
var _OneOfRelatedStoriesDeprecatedRelatedStories = _interopRequireDefault(require("../model/OneOfRelatedStoriesDeprecatedRelatedStories"));

var _OneOfStoriesDeprecatedStories = _interopRequireDefault(require("../model/OneOfStoriesDeprecatedStories"));
  ...
  */
  ...
  _createClass(DefaultApi, [{
    ...
    value: function advancedListStories(body, opts, callback) {
      ...
      var returnType = _OneOfStoriesDeprecatedStories["default"];
    ...
    value: function listRelatedStoriesGet(opts, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json', 'text/xml'];
      var returnType = _OneOfRelatedStoriesDeprecatedRelatedStories["default"];
