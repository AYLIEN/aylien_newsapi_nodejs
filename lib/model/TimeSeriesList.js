...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TimeSeries'], factory);
   ...
   */
  exports.prototype['time_series'] = undefined;
   ...
   */
  exports.prototype['published_at.start'] = undefined;

  /**
   * The end published date of the time series
   * @member {Date} published_at.end
   */
  exports.prototype['published_at.end'] = undefined;
