...
/**
* Histogram service.
* @module api/HistogramApi
* @version 4.0.0
*/
export default class HistogramApi {

    /**
    * Constructs a new HistogramApi. 
    * @alias module:api/HistogramApi
    * @class
    ...
    */
     ...
     * @callback module:api/HistogramApi~listHistogramsCallback
     ...
     * @param {module:api/HistogramApi~listHistogramsCallback} callback The callback function, accepting three arguments: error, data, response
