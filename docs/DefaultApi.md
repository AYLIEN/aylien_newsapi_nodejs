...
> DeprecatedStories advancedListStories(body, opts)
...
> DeprecatedRelatedStories listRelatedStoriesGet(opts)
...
> DeprecatedRelatedStories listRelatedStoriesPost(opts)
...
> DeprecatedStories listStories(opts)
