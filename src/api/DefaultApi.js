...
import OneOfLogicalsParameter from '../model/OneOfLogicalsParameter';
...
export default class DefaultApi {
    ...
    */
     ...
     * @param {module:model/UNKNOWN_BASE_TYPE} UNKNOWN_BASE_TYPE /stories body schema to perform an advanced search with logical operators and nested objects. 
     ...
     */
    advancedListStories(UNKNOWN_BASE_TYPE, opts, callback) {
      opts = opts || {};
      let postBody = UNKNOWN_BASE_TYPE;
      // verify the required parameter 'UNKNOWN_BASE_TYPE' is set
      if (UNKNOWN_BASE_TYPE === undefined || UNKNOWN_BASE_TYPE === null) {
        throw new Error("Missing the required parameter 'UNKNOWN_BASE_TYPE' when calling advancedListStories");
      }
     ...
     * @param {Array.<String>} opts.notEntitiesSurfaceFormsText This parameter is used to exclude stories based on the specified entity's `surface_form`. You can read more about working with entities [here](https://newsapi.aylien.com/docs/working-with-entities). 
    ...
    listHistograms(opts, callback) {
      ...
      let queryParams = {
        ...
        '!entities.surface_forms.text[]': this.apiClient.buildCollectionParam(opts['notEntitiesSurfaceFormsText'], 'multi'),
