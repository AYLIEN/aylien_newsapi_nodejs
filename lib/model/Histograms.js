  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('interval.start')) {
        obj['intervalStart'] = ApiClient.convertToType(data['interval.start'], 'Integer');
      }
      if (data.hasOwnProperty('interval.end')) {
        obj['intervalEnd'] = ApiClient.convertToType(data['interval.end'], 'Integer');
      }
      if (data.hasOwnProperty('interval.width')) {
        obj['intervalWidth'] = ApiClient.convertToType(data['interval.width'], 'Integer');
      }
