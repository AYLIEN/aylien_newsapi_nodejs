...
export default class DefaultApi {
    ...
    */
     ...
     * @param {module:model/DeprecatedStories} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/DeprecatedStories}
     */
    advancedListStories(body, opts, callback) {
      ...
      let returnType = DeprecatedStories;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/DeprecatedRelatedStories} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/DeprecatedRelatedStories}
     */
    listRelatedStoriesGet(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json', 'text/xml'];
      let returnType = DeprecatedRelatedStories;
      return this.apiClient.callApi(
        '/related_stories', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
