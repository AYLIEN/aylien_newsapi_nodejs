  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('characters_count')) {
        obj['charactersCount'] = ApiClient.convertToType(data['characters_count'], 'Integer');
      }
      if (data.hasOwnProperty('words_count')) {
        obj['wordsCount'] = ApiClient.convertToType(data['words_count'], 'Integer');
      }
      if (data.hasOwnProperty('sentences_count')) {
        obj['sentencesCount'] = ApiClient.convertToType(data['sentences_count'], 'Integer');
      }
      if (data.hasOwnProperty('paragraphs_count')) {
        obj['paragraphsCount'] = ApiClient.convertToType(data['paragraphs_count'], 'Integer');
      }
