...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AylienNewsApi.DeprecatedEntity();
  });
  ...
  describe('DeprecatedEntity', function() {
    it('should create an instance of DeprecatedEntity', function() {
      // uncomment below and update the code to test DeprecatedEntity
      //var instane = new AylienNewsApi.DeprecatedEntity();
      //expect(instance).to.be.a(AylienNewsApi.DeprecatedEntity);
    });
