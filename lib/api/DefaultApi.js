...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} opts.perPage This parameter is used for specifying number of items in each page. (default to 3)
     ...
     * @param {Array.<Integer>} opts.categoriesLevel This parameter is used for finding stories by categories level.
     ...
     * @param {Integer} opts.mediaImagesCountMin This parameter is used for finding stories whose number of images is greater than or equal to the specified value.
     * @param {Integer} opts.mediaImagesCountMax This parameter is used for finding stories whose number of images is less than or equal to the specified value.
     * @param {Integer} opts.mediaVideosCountMin This parameter is used for finding stories whose number of videos is greater than or equal to the specified value.
     * @param {Integer} opts.mediaVideosCountMax This parameter is used for finding stories whose number of videos is less than or equal to the specified value.
     ...
     * @param {Integer} opts.perPage This parameter is used for specifying number of items in each page. (default to 10)
