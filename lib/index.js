...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Author', 'model/Autocomplete', 'model/Autocompletes', 'model/Category', 'model/CategoryLinks', 'model/Coverages', 'model/Entities', 'model/Entity', 'model/EntityLinks', 'model/Error', 'model/ErrorLinks', 'model/Errors', 'model/HistogramInterval', 'model/Histograms', 'model/Location', 'model/Media', 'model/RelatedStories', 'model/Scope', 'model/Sentiment', 'model/Sentiments', 'model/ShareCount', 'model/ShareCounts', 'model/Source', 'model/Stories', 'model/Story', 'model/StoryCluster', 'model/StoryLinks', 'model/Summary', 'model/TimeSeries', 'model/TimeSeriesList', 'model/Trend', 'model/Trends', 'api/DefaultApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Author'), require('./model/Autocomplete'), require('./model/Autocompletes'), require('./model/Category'), require('./model/CategoryLinks'), require('./model/Coverages'), require('./model/Entities'), require('./model/Entity'), require('./model/EntityLinks'), require('./model/Error'), require('./model/ErrorLinks'), require('./model/Errors'), require('./model/HistogramInterval'), require('./model/Histograms'), require('./model/Location'), require('./model/Media'), require('./model/RelatedStories'), require('./model/Scope'), require('./model/Sentiment'), require('./model/Sentiments'), require('./model/ShareCount'), require('./model/ShareCounts'), require('./model/Source'), require('./model/Stories'), require('./model/Story'), require('./model/StoryCluster'), require('./model/StoryLinks'), require('./model/Summary'), require('./model/TimeSeries'), require('./model/TimeSeriesList'), require('./model/Trend'), require('./model/Trends'), require('./api/DefaultApi'));
  }
}(function(ApiClient, Author, Autocomplete, Autocompletes, Category, CategoryLinks, Coverages, Entities, Entity, EntityLinks, Error, ErrorLinks, Errors, HistogramInterval, Histograms, Location, Media, RelatedStories, Scope, Sentiment, Sentiments, ShareCount, ShareCounts, Source, Stories, Story, StoryCluster, StoryLinks, Summary, TimeSeries, TimeSeriesList, Trend, Trends, DefaultApi) {
  'use strict';
